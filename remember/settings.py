...
SECRET_KEY = 'django-insecure-!y90$p3)sr_+5edfzbjz6)p-7)uw0$imbi2j)p)if98ng(e!qa'
...
STATIC_URL = 'static/'
STATICFILES_STORAGE='whitenoise.storage.CompressedManifastStaticFilesStorage'
